...
Orr and colleagues, in a 2014 study published in the *Journal of Occupational Rehabilitation*, surveyed Australian Army soldiers and found that load carriage was among the most frequently cited causes of musculoskeletal injury [@orr2014]. In a subsequent 2016 study, thirty-four percent of soldiers reported injuries directly attributed to load carriage, with the lower back, knees, and ankles the most commonly affected sites [@orr2016]. A 2013 narrative review of the broader military injury literature confirmed that load carriage injuries are not occasional misfortunes but systematic consequences of the activity at operational loads and volumes [@orr2013].
...
|-------|--------------|-------|---------------|---------------|
| Loaded walking produces distinct neuromuscular and gait adaptations | Systematic review | **Moderate** | Walsh & Low 2021 | Military populations only; civilian replication limited |
| Load carriage conditions paraspinal musculature (+8% in 20 days) | Observational (pre-post) | **Low** | Qu 2020 | Single study, young military males, 30% BW load |
| Military load carriers maintain high testosterone profiles | Cross-sectional observational | **Low** | Taylor 2016 | Survivorship bias; diverse training confounds; cannot isolate load carriage as causal |
| Load carriage improves HRV (parasympathetic adaptation) | Observational (pre-post) | **Low** | Lowe 2025; Qu 2020 | Young military males only; no data in civilians over 40 |
| Military load carriage causes 34% injury rate | Survey / observational | **Moderate** | Orr 2016; Orr 2014 | Military loads (>40% BW) far exceed recreational recommendation (15-25% BW) |
| Military findings generalise to civilian rucking populations | Extrapolation | **Very Low** | No direct evidence | *Ecological fallacy risk:* young, selected, supervised military vs. unsupervised civilian adults |
