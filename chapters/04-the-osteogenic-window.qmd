...
In 2025, Beavers and colleagues published a result in *JAMA Network Open* that anyone citing weighted loading for bone health is obligated to address honestly [@beavers2025].
...
|-------|--------------|-------|---------------|---------------|
| Loaded walking produces GRF in the osteogenic range (1.4-1.7× BW) | Biomechanical measurement | **High** | Nilsson & Thorstensson 1989 | Direct measurement; well-replicated |
| GRF in the osteogenic range produces bone formation | Mechanistic (Wolff's Law) + observational | **Moderate** | Multiple; Wolff 1892; astronaut studies | Wolff's Law well-established; specific dose-response in loaded walking less precise |
| Weighted vest + jumping preserves femoral neck BMD in postmenopausal women | RCT (5-year) | **Moderate** | Snow 2000 | Jumping component confounds the vest-alone effect |
| Weighted vest alone prevents bone loss in older adults | RCT (12-month) | **Moderate** | Beavers 2025 | *NEGATIVE FINDING:* Weighted vest during daily activities did NOT prevent bone loss during weight loss (N=150, JAMA Network Open) |
| Rucking specifically builds bone in civilians | Extrapolation | **Very Low** | No direct evidence | *Full chain untested:* GRF measurement → osteogenic threshold → bone density change specifically from rucking has never been studied as a single causal chain |
| Non-supervised weight-bearing exercise improves BMD in women with osteopenia | Meta-analysis | **High** | Sánchez-Trigo 2022 | SMD 0.73-0.85; but "weight-bearing exercise" is broader than rucking alone |
