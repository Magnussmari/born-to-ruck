...
**AI Tools Disclosure (ICMJE-compliant).** This manuscript was researched and written using the following AI tools: Claude (Anthropic, models claude-3.5-sonnet through claude-opus-4-6) via Claude Code CLI running on the PAI (Personal AI) infrastructure; Google Gemini (3.0 Flash through 3.1 Pro); Perplexity AI; and scite.ai for citation verification. The author prepared all research prompts, defined chapter scope and voice, reviewed all output, and made all editorial decisions. AI tools performed literature retrieval, synthesis drafting, citation verification, and adversarial bias auditing. No AI system is listed as an author. Full methodology is documented in Appendix B (prompts) and Appendix C (bias audit).
:::
